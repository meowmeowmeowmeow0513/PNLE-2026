...
const ProfileSettings: React.FC<ProfileSettingsProps> = ({ onClose }) => {
    ...
    return createPortal(
        <div className="fixed inset-0 z-[9999] grid place-items-center p-0 sm:p-4 md:p-6 animate-fade-in">
          ...
          animate-zoom-in
        "
                // stop click bubbling so backdrop doesn't close when clicking inside
            ...
            >
                ...
                <div className="sm:hidden sticky top-0 z-30 flex items-center justify-between px-5 py-4 border-b border-slate-100 dark:border-slate-800 bg-white dark:bg-[#0f172a]">
                ...
                {/* ✅ Body: switches layout smoothly */}
                <div className="flex-1 min-h-0 flex flex-col md:flex-row">
                    {/* ✅ Nav: horizontal tabs on narrow screens, sidebar on wider screens */}
                    <div
                        className="
              w-full md:w-72
              shrink-0
              bg-slate-50/80 dark:bg-[#0B1121]/80
              border-b md:border-b-0 md:border-r border-slate-200 dark:border-white/5
              backdrop-blur-md
              px-2 py-2 md:p-6
            "
                    >
                        ...
                        <div className="flex md:flex-col gap-2 overflow-x-auto md:overflow-visible no-scrollbar">
                            <button
                                ...
                                className={`flex items-center gap-3 px-4 py-2.5 md:py-3.5 rounded-xl md:rounded-2xl transition-all text-xs md:text-sm font-bold whitespace-nowrap flex-shrink-0 ${activeTab === 'profile'
                            ...
                            <button
                                ...
                                className={`flex items-center gap-3 px-4 py-2.5 md:py-3.5 rounded-xl md:rounded-2xl transition-all text-xs md:text-sm font-bold whitespace-nowrap flex-shrink-0 ${activeTab === 'appearance'
                                    ? 'bg-pink-500 text-white shadow-lg shadow-pink-500/20 ring-1 ring-pink-400'
                                    : 'text-slate-500 hover:bg-white dark:hover:bg-white/5 hover:text-slate-700 dark:text-slate-400'
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`flex items-center gap-3 px-4 py-2.5 md:py-3.5 rounded-xl md:rounded-2xl transition-all text-xs md:text-sm font-bold whitespace-nowrap flex-shrink-0 ${activeTab === 'account'
                                    ? 'bg-pink-500 text-white shadow-lg shadow-pink-500/20 ring-1 ring-pink-400'
                                    : 'text-slate-500 hover:bg-white dark:hover:bg-white/5 hover:text-slate-700 dark:text-slate-400'
                                    }`}
                            >
                        ...
                        <div className="hidden md:block mt-6 pt-4 border-t border-slate-200 dark:border-white/5">
                            <button
                                onClick={onClose}
                                className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-2xl border border-slate-200 dark:border-white/10 text-slate-500 hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-white/5 transition-all text-sm font-bold"
                            >
                    ...
                    {/* ✅ Content Area */}
                    <div className="flex-1 min-w-0 min-h-0 relative bg-white dark:bg-[#0f172a]">
                        {/* Toast */}
                        {message && (
                            <div className="pointer-events-none absolute top-4 left-4 right-4 sm:left-1/2 sm:-translate-x-1/2 sm:w-auto z-50">
                                <div
                                    className={`pointer-events-auto flex items-center gap-3 px-4 py-3 rounded-xl shadow-2xl border ${message.type === 'success'
                        ...
                        {/* ✅ Scroll area (reliable across heights) */}
                                ...
                                {activeTab === 'profile' && (
                                    <div className="space-y-8">
                                        <div className="relative rounded-3xl md:rounded-[2.5rem] overflow-hidden bg-white dark:bg-slate-900 text-slate-900 dark:text-white shadow-2xl border border-slate-200 dark:border-slate-800 transition-colors duration-300 group">
                                            ...
                                            <div className="absolute top-0 right-0 w-64 h-64 bg-white/20 rounded-full blur-[80px] pointer-events-none -mr-16 -mt-16 mix-blend-overlay" />
                                            ...
                                            <div className="relative z-10 p-6 sm:p-7 md:p-8 flex flex-col items-center">
                                                ...
                                                <div className="grid grid-cols-3 gap-2 sm:gap-3 w-full max-w-sm">
                                                    <div className="bg-slate-50 dark:bg-white/5 backdrop-blur-md rounded-2xl p-2 md:p-3 text-center border border-slate-200 dark:border-white/10 shadow-sm">
                                                        ...
                                                        <div className="text-xs md:text-sm font-black text-slate-800 dark:text-white text-center leading-snug break-words whitespace-normal">{currentRank?.title}</div>
                                                    </div>
                                                    <div className="bg-slate-50 dark:bg-white/5 backdrop-blur-md rounded-2xl p-2 md:p-3 text-center border border-slate-200 dark:border-white/10 shadow-sm">
                                    ...
                                    <div className="space-y-10">
                                        <div>
                                            <div className="flex items-start sm:items-center justify-between gap-3 mb-2 flex-col sm:flex-row">
                                                ...
                                                <button
                                                    onClick={resetTheme}
                                                    className="text-xs font-bold text-pink-500 hover:text-pink-600 flex items-center gap-1 bg-pink-50 dark:bg-pink-500/10 px-3 py-1 rounded-full"
                                                >
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                                {['light', 'dark', 'crescere'].map((mode) => (
                                                    <button
                                                        ...
                                                        className={`relative p-2 rounded-2xl border-2 transition-all flex flex-col items-center gap-3 group overflow-hidden ${themeMode === mode
                                                            ? mode === 'crescere'
                                                                ? 'border-rose-500 bg-rose-50 ring-2 ring-rose-500/20'
                                                                : 'border-pink-500 bg-pink-50/50 dark:bg-pink-900/10 ring-2 ring-pink-500/20'
                                                            : 'border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600'
                                                            }`}
                                                    >
                                                        <div className={`w-full aspect-video rounded-xl border flex items-center justify-center relative shadow-sm overflow-hidden ${mode === 'light' ? 'bg-white border-slate-200' :
                                                        ...
                                                        {themeMode === mode && (
                                                            <div className="absolute top-2 right-2 text-pink-500 bg-white rounded-full p-0.5 shadow-sm">
                                            ...
                                            <div className="space-y-6">
                                                    ...
                                                    <div className="flex bg-slate-100 dark:bg-slate-800 p-1 rounded-xl overflow-x-auto no-scrollbar">
                                                        {['small', 'normal', 'large', 'extra-large'].map((size) => (
                                                            <button
                                                                ...
                                                                className={`min-w-[88px] sm:min-w-0 flex-1 py-2 rounded-lg text-xs font-bold transition-all ${fontSize === size
                                                                    ? 'bg-white dark:bg-slate-700 shadow-sm text-slate-900 dark:text-white'
                                                                    : 'text-slate-500 hover:text-slate-700 dark:hover:text-slate-300'
                                                                    }`}
                                                            >
                                                                Ag
                                                                <span className="block text-[9px] mt-0.5 opacity-60 uppercase">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                                        <button
                                                            ...
                                                            className={`p-3 rounded-xl border text-sm font-sans transition-all ${fontFamily === 'sans'
                                                        ...
                                                        <button
                                                            ...
                                                            className={`p-3 rounded-xl border text-sm font-serif transition-all ${fontFamily === 'serif'
                                                                ? 'border-pink-500 bg-pink-50 dark:bg-pink-900/20 text-pink-700 dark:text-pink-300 ring-1 ring-pink-500'
                                                                : 'border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-300'
                                                                }`}
                                                        >
                                                        ...
                                                        <button
                                                            ...
                                                            className={`p-3 rounded-xl border text-sm font-mono transition-all ${fontFamily === 'mono'
                                                                ? 'border-pink-500 bg-pink-50 dark:bg-pink-900/20 text-pink-700 dark:text-pink-300 ring-1 ring-pink-500'
                                                                : 'border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-300'
                                                                }`}
                                                        >
                                                ...
                                                <div className="flex items-center justify-between gap-4 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-200 dark:border-slate-700">
                                                    ...
                                                    <button
                                                        ...
                                                        className={`w-12 h-7 rounded-full transition-colors relative shrink-0 ${reduceMotion ? 'bg-pink-500' : 'bg-slate-300 dark:bg-slate-600'
                                                            }`}
                                                    >
                                                        <div
                                                            className={`absolute top-1 w-5 h-5 bg-white rounded-full transition-transform shadow-sm ${reduceMotion ? 'translate-x-6' : 'translate-x-1'
                                                                }`}
                                                        />
                                                    </button>
                                                </div>
                                                ...
                                                <div className="flex flex-wrap gap-4 justify-start">
                                                    {presetColors.map((color) => (
                                                        <button
                                                            ...
                                                            className={`w-10 h-10 md:w-12 md:h-12 rounded-full transition-all flex items-center justify-center shadow-sm hover:scale-110 ${accentColor.toLowerCase() === color.toLowerCase()
                                        ...
                                        <div className="pt-6 border-t border-slate-200 dark:border-slate-700/50">
                                            ...
                                            {!showDeleteConfirm ? (
                                                <button
                                                    ...
                                                    className="w-full flex items-center justify-between gap-4 p-4 bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-900/30 rounded-2xl group hover:bg-red-100 dark:hover:bg-red-900/20 transition-colors"
                                                >
                                                    <div className="flex items-center gap-3 min-w-0">
                                                        ...
                                                        <div className="text-left min-w-0">
                                                            ...
                                                            <p className="text-xs text-red-400/80 truncate">Permanently remove all data</p>
                                                        </div>
                                                    </div>
                                                    <div className="text-red-400 group-hover:translate-x-1 transition-transform shrink-0">
                                                ...
                                                <div className="bg-red-50 dark:bg-red-900/10 border border-red-200 dark:border-red-900/30 rounded-2xl p-5">
                                                    ...
                                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                        <button
                                                            ...
                                                            className="py-2.5 bg-red-600 text-white rounded-xl font-bold text-sm hover:bg-red-700 shadow-lg shadow-red-500/20 transition-all flex items-center justify-center gap-2"
                                                        >
                                                            {deleteLoading ? <Loader size={16} className="animate-spin" /> : 'Yes, Delete Everything'}
                                                        </button>
                                                        <button
                                                            onClick={() => setShowDeleteConfirm(false)}
                                                            className="py-2.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 rounded-xl font-bold text-sm hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
                                                        >
                                                            Cancel
                                                        </button>
                                                    </div>
                        ...
                        {/* ✅ Sticky action padding spacer for iOS + short heights */}
