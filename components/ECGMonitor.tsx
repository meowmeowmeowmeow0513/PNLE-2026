...
interface ECGMonitorProps {
    ...
    customHR?: number | null; // New prop for dynamic heart rate
}

const ECGMonitor: React.FC<ECGMonitorProps> = ({ rhythm, isShocking, phase, padsAttached, customHR }) => {
    const getPath = (r: Rhythm) => {
        ...
        switch(r) {
            ...
            // PEA typically looks like Sinus but with NO PULSE. Updated to look like Sinus Tachycardia.
            ...
            case 'VT': return "M0 50 L10 10 L20 90 L30 10 L40 90 L50 10 L60 90 L70 10 L80 90 L90 10 L100 90 L110 10 L120 90 L130 10 L140 90 L200 50"; // More regular sawtooth
            case 'ASYSTOLE': return "M0 50 Q10 50 20 51 T40 49 T60 50 T80 51 T100 49 T120 50 T140 50 T200 50"; // Slight wander
            case 'TORSADES': return "M0 50 C 20 0, 40 100, 60 50 C 80 0, 100 80, 120 50 C 140 20, 160 90, 180 50 L 200 50"; // Twisting
            case 'BRADYCARDIA': return "M0 50 L30 50 L35 45 L40 55 L45 50 L60 50 L65 30 L70 70 L75 50 L150 50 L200 50"; // Slow
    ...
    if (padsAttached) {
        if (customHR) {
            ...
            switch (rhythm) {
                ...
                default: displayHR = '---'; // VFIB/TORSADES usually don't track a numeric rate accurately
            }
        }
    }

    return (
        <div className="w-full h-48 md:h-72 bg-slate-200 dark:bg-slate-800 rounded-2xl border-[6px] border-slate-300 dark:border-slate-700 relative overflow-hidden shadow-inner group flex flex-col font-mono select-none transition-colors duration-300">
            ...
            <div className="flex-1 bg-black relative flex flex-col m-[2px] rounded-lg overflow-hidden border border-slate-700">
                {/* Monitor Brand */}
                ...
                {/* Grid Lines - Optimized for Light/Dark perception inside the black screen */}
                <div className="absolute inset-0 opacity-20 pointer-events-none" 
                     style={{ backgroundImage: 'linear-gradient(#334155 1px, transparent 1px), linear-gradient(90deg, #334155 1px, transparent 1px)', backgroundSize: '20px 20px' }}>
                </div>
                
                {/* ECG Trace (Top Section) */}
